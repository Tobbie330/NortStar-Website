...
<section class="section">
	<div class="container areas-layout">
		<div class="areas-copy">
			...
			<h2>Local, Reliable Landscaping Near You</h2>
			<p>We provide landscape design, lawn care, hardscaping, planting, and seasonal maintenance throughout the communities below. Don't see your area? Give us a call — we likely cover it.</p>
			<ul class="areas-grid">
...
<section class="section section--dark" style="text-align:center;">
	<div class="container" style="max-width:720px;">
		...
		<h2>Need Landscaping in Your Neighborhood?</h2>
		<p style="color:rgba(244,241,232,.8);">Call <a href="tel:<?php echo esc_attr( northstar_opt( 'phone_link', '+19893184491' ) ); ?>" style="color:var(--ns-olive-bright);"><?php echo esc_html( $phone ); ?></a> or request a free estimate online.</p>
